...
import { convertTime, ageCalculator, juniorCompetitionTypeChange } from "./helpers.js";
...
function showJuniorTable(result) {
  ...
  if (age < 18) {
    ...
    <tr>
      <td style="color: blue; cursor: pointer" class="name">${member.firstName} ${member.lastName}</td>
