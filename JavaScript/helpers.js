...
function memberPrice(member) {
  let HTML = "";
  if (ageCalculator(member) >= 18 && ageCalculator(member) < 60 && member.active === "true") {
    HTML = /*html*/ `1600`;
...
function juniorCompetitionTypeChange(event) {
  const selectedTargetValue = event.target.value;
  if (selectedTargetValue === "Konkurrence") {
    document.querySelector("#junior-competition-name").removeAttribute("hidden");
    document.querySelector("#junior-competition-name-label").removeAttribute("hidden");
    ...
    document.querySelector("#junior-competition-name").setAttribute("hidden", "true");
    document.querySelector("#junior-competition-name-label").setAttribute("hidden", "true");
    document.querySelector("#junior-placement-label").setAttribute("hidden", "true");
